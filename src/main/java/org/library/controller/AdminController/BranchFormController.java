...
import org.library.controller.Table_Row.BranchRowController;
...
public class BranchFormController {
    ...
    public void AddUserOnActhion(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/forms/tableRow/Save/BranchSave.fxml"));
        try {
    ...
    private void laodTable() {
        ...
        for (BranchDto branchDto : all) {
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/forms/tableRow/BranchRow.fxml"));
                Parent root = fxmlLoader.load();
