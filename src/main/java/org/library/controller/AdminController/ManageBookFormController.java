...
import org.library.controller.Table_Row.BookRowController;
...
public class ManageBookFormController implements Initializable {
    ...
    void LoadTable() throws IOException {
        ...
        for (int i = 0; i < all.size(); i++) {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/forms/tableRow/bookRow.fxml"));
    ...
    public void AddBtnOnActhion(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/forms/tableRow/Save/SaveBook.fxml"));
    ...
    public void searchOnActhion(ActionEvent actionEvent) {
        ...
        if (bookDto != null){
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/forms/tableRow/View/ViewBook.fxml"));
            Parent parent = null;
            try {
