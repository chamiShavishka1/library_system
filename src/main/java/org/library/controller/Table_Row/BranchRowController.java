...
import org.library.bo.BranchService;
import org.library.bo.ServiceFactor;
import org.library.controller.Table_Row.Update.UpdateBranchFormController;
import org.library.controller.Table_Row.View.ViewBranchFormController;
...
public class BranchRowController {
    ...
    public void viewBtnOnActhion(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/forms/tableRow/View/Branch.fxml"));
        try {
    ...
    public void editBtnOnActhion(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/forms/tableRow/UpDate/BranchUpdate.fxml"));
        try {
            Parent parent = fxmlLoader.load();
