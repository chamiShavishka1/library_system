...
public class ServiceFactor {
    ...
    public enum BoType{
        Member,Admin,Search_Book,Register,Manage_Book,UserMange,Branch,DashBoard,MemberDashBoard,Admin_Register, Return_Book, forgetPassword, Borrow_Book
    }
